...
class Relation(Base):
    ...
    __table_args__ = (UniqueConstraint("master_person_id", "slave_person_id", name="uq_relation_master_slave"),)

    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    master_person_id: Mapped[int] = mapped_column(Integer, ForeignKey("person.id"), nullable=False)
    slave_person_id: Mapped[int] = mapped_column(Integer, ForeignKey("person.id"), nullable=False)
